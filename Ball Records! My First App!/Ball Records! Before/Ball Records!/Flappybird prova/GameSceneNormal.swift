...
class GameSceneNormal: SKScene, SKPhysicsContactDelegate {
    ...
    func createScene(){
        ...
        difficulty.fontColor = UIColor.orangeColor()
    ...
    override func didMoveToView(view: SKView){
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(GameSceneNormal.pauseGame), name: "pauseGame", object: nil)
    ...
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        if gameStarted == false{
            ...
            let spawn9D1 = SKAction.runBlock({() in self.createBarre9S()})
    ...
    func createWalls(){
        ...
        scoreNode.physicsBody?.categoryBitMask = PhysicsCatagoryN.Score
